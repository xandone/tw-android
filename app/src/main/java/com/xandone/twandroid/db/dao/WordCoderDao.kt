 ...
 */
@Dao
interface WordCoderDao {
    @Query("select * from ${DBInfo.TABLE_CODER} order by wid asc limit :pageSize offset :offset")
    suspend fun loadDB(pageSize: Int, offset: Int): List<WordCoder>
